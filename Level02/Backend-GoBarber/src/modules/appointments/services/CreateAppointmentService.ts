...
class CreateAppointmentService {
  ...
  public async execute({
    ...
    const findAppoitmentInTheSameDate = await this.appointmentsRepository.findByDate(
      appointmentDate,
    );

    if (findAppoitmentInTheSameDate) {
    ...
    await this.notificationsRepository.create({
      ...
      content: `Novo aagendamento para o dia ${dateFormatted}`,
    });

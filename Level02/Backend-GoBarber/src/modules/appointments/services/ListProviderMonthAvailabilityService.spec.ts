...
import ListProviderMonthsAvailabilityService from './ListProviderMonthAvailabilityService';
...
describe('ListProviderMonthAvailability', () => {
  ...
  it('Should be able to list the month availabiblity from provider', async () => {
